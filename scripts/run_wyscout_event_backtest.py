...
from football_v2.cross_league_tail import leave_one_league_out_test
...
def main() -> None:
    ...
    cross_league_jackpot = leave_one_league_out_test(
        market_event_dataset,
        target_column="tail_target",
        config=config,
    )
    cross_league_upset = leave_one_league_out_test(
        market_event_dataset,
        target_column="upset_jackpot_target",
        config=upset_config,
    )
    payload = {
        ...
        "cross_league_jackpot": cross_league_jackpot.to_dict(),
        "cross_league_upset_jackpot": cross_league_upset.to_dict(),
        "dataset": {
